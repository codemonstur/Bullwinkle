...
public final class Xml implements OutputFormatVisitor {
	...
	private final Deque<String> parents;
	...
	@Override
	public void pop() {
		output.append(indents.pop()).append(LESS_THAN).append(FORWARD_SLASH).append(parents.pop()).append(GREATER_THAN).append(NEW_LINE);
	}
